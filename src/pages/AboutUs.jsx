        ...
        <div className="container">
          ...
          <div className={styles.differentGrid}>
            ...
            >
              <div className={styles.flipCardInner}>
                <div className={styles.flipCardFront}>
                  ...
                  <h3 className={styles.flipCardTitle}>State-of-the-Art Dental Technology</h3>
                </div>
                <div className={styles.flipCardBack}>
                  <div className={styles.differentIcon}>
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
            ...
            >
              <div className={styles.flipCardInner}>
                <div className={styles.flipCardFront}>
                  <img src="/home/1.jpeg" alt="Transparent Communication" className={styles.flipCardImage} />
                  <h3 className={styles.flipCardTitle}>Transparent Communication</h3>
                </div>
                <div className={styles.flipCardBack}>
                  <div className={styles.differentIcon}>
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
