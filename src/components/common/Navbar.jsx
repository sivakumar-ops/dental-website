        ...
        <div className="container">
          <div className={styles.navContent}>
            ...
            <Link to="/" className={styles.logo} aria-label="Dental 128 Home">
              <img src="/logotext.png" alt="Dentovate" width="120" height="32" />
            </Link>
            ...
            <div className={styles.navActions}>
              <a href="tel:9133333552" className={styles.phoneLink} aria-label="Call us at 9133333552">
          ...
          {isMobileMenuOpen && (
            ...
            >
              <ul className={styles.mobileNavLinks}>
                ...
                >
                  <a href="tel:9133333552" className={styles.mobilePhone}>
                    📞 9133333552
                  </a>
                </motion.li>
              </ul>
